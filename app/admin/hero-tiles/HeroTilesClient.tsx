...
const slotMeta: Record<HeroTileSlot, { title: string; helper: string; order: number }> = {
  left_top: {
    title: 'Left Tile (Top)',
    helper: 'Upper-left tile beside the hero feature.',
    order: 10,
  },
  left_bottom: {
    title: 'Left Tile (Bottom)',
    helper: 'Lower-left tile beside the hero feature.',
    order: 20,
  },
  center: {
    title: 'Featured Center Tile',
    helper: 'Primary hero tile spanning the middle columns.',
    order: 30,
  },
  right_top: {
    title: 'Right Tile (Top)',
    helper: 'Upper-right tile beside the hero feature.',
    order: 40,
  },
  right_middle: {
    title: 'Right Tile (Bottom)',
    helper: 'Lower-right tile beside the hero feature.',
    order: 50,
  },
}
        ...
        return (
          <div key={slot} className="rounded-2xl bg-white shadow-card p-6 space-y-5 border border-neutral-100">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-semibold text-neutral-400">{slot.replace('_', ' ')}</span>
            </div>
