        ...
        <ScrollReveal stagger={100} className="flex flex-col gap-4">
          {channels.map((ch) => (
            <a
              ...
              className="flex items-center gap-5 bg-white border border-border-soft rounded-2xl px-6 py-5 hover:border-ink-strong/30 hover:shadow-soft transition-[border-color,box-shadow] group"
            >
