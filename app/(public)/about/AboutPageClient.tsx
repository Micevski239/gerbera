...
export default function AboutPageClient({ stats }: AboutPageClientProps) {
  const values = [
    {
      ...
      desc: 'Секој аранжман е рачно изработен со внимание кон секој детал, за да добиете уникатен и внимателно дизајниран подарок.',
      icon: (
    ...
    },
    {
      ...
      desc: 'Не постојат два идентични аранжмани. Секој подарок е креиран да биде посебен и незаборавен.',
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Брза достава',
      desc: 'Вашиот подарок го доставуваме брзо и сигурно, директно до адресата на примачот.',
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Создадено со љубов',
      desc: 'Во секој производ вложуваме креативност, време, внимание и многу љубов.',
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Подготвено за подарување',
      desc: 'Нема потреба да се грижите за ништо. Секој производ доаѓа внимателно спакуван и подготвен да биде совршено изненадување.',
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Лесна нарачка',
      desc: 'Нарачајте брзо и едноставно преку Instagram, Facebook или WhatsApp.',
      icon: (
  ...
  return (
    <div className="bg-canvas-100 text-ink-base">
      ...
      >
        <div className="container-custom h-48 md:h-56 flex flex-col items-center justify-center text-center relative z-10">
          ...
          <p className="text-ink-muted max-w-lg mx-auto">
            Бренд создаден со љубов кон цвеќето, креативноста и убавите моменти во животот.
          </p>
        </div>
      </section>
      ...
      {/* Story */}
      <ScrollReveal>
        <div className="container-custom py-14 md:py-20 text-center max-w-2xl mx-auto">
          <h2 className="font-heading text-2xl md:text-3xl text-ink-strong mb-4">
            Секој подарок раскажува приказна
          </h2>
          <p className="text-ink-muted leading-relaxed">
            Создаваме уникатни рачно изработени цветни аранжмани, декоративни подароци и изненадувања за секоја посебна прилика. Со внимание кон секој детал, вашите емоции ги претвораме во совршен подарок.
          </p>
        </div>
      </ScrollReveal>
