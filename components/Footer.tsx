...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#880f4f] text-white mt-auto border-t border-white/20">
      {/* Main footer content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="group mb-4 inline-block">
              <span className="font-heading text-2xl text-white group-hover:text-white/80 transition-colors">
                Gerbera
              </span>
            </Link>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-medium text-white/80 uppercase tracking-elegant mb-4">
              {t('footer.quickLinks')}
            </h3>
